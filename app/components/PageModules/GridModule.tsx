...
const SectionModule = ({paddingInline=0, gap=0, rounded=true, columns=2, dynamic=true, backgroundColor="var(--panel-color)", showBack=false, children, positioning=undefined} : GridProps) => {
  return (
    <div 
        className={`
